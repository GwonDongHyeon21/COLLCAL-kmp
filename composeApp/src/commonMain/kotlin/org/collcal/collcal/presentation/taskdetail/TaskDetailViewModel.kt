    ...
    fun getTaskInfo(task: Task?) {
        task?.let {
            _taskInfo.value = when (it.title) {
                "학부연구생" -> TaskInfo(
                    "학부연구생 : 교수님의 연구실에서 연구보조 업무 수행. 데이터 수집, 실험 설계, 논문 작성 일부 보조" +
                            "등의 역할을 담당. 연구실 세미나 참석 및 논문 발표 준비에 참여..",
                    "적정시기 : 3 학년 1 학기부터 지원서 제출 추천",
                    listOf(
                ...
                "전공연수" -> TaskInfo(
                    "전공연수 : 전공 관련 해외 교육기관이나 대학에서 단기 수업/워크숍/현장견학 등에 참여. (해외 계절학기)",
                    "적정시기 : 2 학년 하계방학부터 꾸준하게 넣어보는 걸 추천",
                    listOf(
                ...
                "현장실습" -> TaskInfo(
                    "현장실습 : 산업체 또는 연구기관에 파견되어 실무를 직접 경험하는 프로그램. 기업 프로젝트 참여, 공정관리/데이터 분석 등 실무 스킬 습득 기회 제공. 학점인정 가능.",
                    "적정시기 : 3 학년 1 학기 이후 휴학학기",
                ...
                "인턴" -> TaskInfo(
                    "인턴 : 기업 또는 연구소에서 일정 기간 정해진 직무를 수행하며 실무 경험을 쌓는 활동. 데이터 분석, 공정 개선, 품질관리, 마케팅 기획 등 다양한 직무에 참여 가능.",
                    "적정시기 : 3 학년 마친 뒤 휴학 기간",
